...
RE.insertImage = function(url, alt) {
    //var html = '<img  src="file://' + url + '" alt="' + alt + '" style="text-align:center; width:100; height:100;"/><p align=center style="color:#aaaaaa">来自筑龙学社App的图片</p><hr align=center width=200 color=#aaaaaa size=1 /><br/><br/>';
    var html = '<img  src="' + url + '" alt="' + alt + '" style="text-align:center; width:100; height:100;"/><p align=center style="color:#aaaaaa">来自筑龙学社App的图片</p><hr align=center width=200 color=#aaaaaa size=1 /><br/><br/>';
