...
public class RichEditorWebView extends WebView{
    ...
    private String EDIT_HTML="file:///android_asset/editor.html";//默认的编辑地址
    ...
    private boolean isReady = false;//是否加载完成
    ...
    protected class EditorWebViewClient extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url) {
            isReady = url.equalsIgnoreCase(EDIT_HTML);
        ...
        public WebResourceResponse shouldInterceptRequest(WebView view, String url) {
            ...
            if(url.contains(key)){
                ...
                response[0] = new WebResourceResponse("image/png", "UTF-8", new ByteArrayInputStream(ImageUtils.bitmapTobyte(imgPath)));
                return response[0];
            }else {
